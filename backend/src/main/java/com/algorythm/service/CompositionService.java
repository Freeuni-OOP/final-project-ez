...
/**
 * Composition CRUD, always scoped to the current user. Lookups go through
 * findByIdAndOwner so one user can never read or modify another user's work
 * (a miss returns 404 rather than revealing that the id exists).
 */
@Service
