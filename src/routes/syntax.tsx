    ...
    <main className="min-h-screen bg-background text-foreground">
      <section className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Each line of your pattern is one track. Write the <em>kind</em> of track,
          then a colon, then a series of tokens separated by spaces. The kind tells
          AlgoRythm what instrument to use; the tokens are what it plays.
        </p>
...
synth: C4 E4 G4 C5`}</Example>
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Every line shares one timing grid. The first token of each line plays on
          the first step, the second token on the second step, and so on, all the
          way across. So tokens that sit in the same column play together. The
...
hat:   hat   hat   hat   hat
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          A single hyphen <code className="rounded bg-foreground/10 px-1">-</code> is
          a rest: that step stays silent. Use rests to leave space and line tracks
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          A <strong>drum</strong> line uses named percussion sounds as its tokens —
          for example <code className="rounded bg-foreground/10 px-1">kick</code>,{" "}
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          A <strong>pitched</strong> line (like <code className="rounded bg-foreground/10 px-1">synth</code>,{" "}
          ...
          <code className="rounded bg-foreground/10 px-1">bass</code>) uses note
          tokens. A note is a letter A–G, an optional{" "}
          <code className="rounded bg-foreground/10 px-1">#</code> (sharp) or{" "}
          <code className="rounded bg-foreground/10 px-1">b</code> (flat), and an
          octave number — for example{" "}
          <code className="rounded bg-foreground/10 px-1">C4</code> or{" "}
          <code className="rounded bg-foreground/10 px-1">F#5</code>. Higher octave
          numbers sound higher.
        </p>
...
bass:  C2 - G2 -`}</Example>
        ...
        <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
          Stack a few lines and they play as one loop. Paste this into the composer
          and hit play:
        </p>
        <Example>{`drum: kick - snare -
